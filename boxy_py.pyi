class Boxy:
    ...
    def add_text_sgmt(self, text: str, color: str, align: str) -> None:
        ...
        Each call adds a new section separated from the previous by a divider line.
        ...
        Example:
            ...
            >>> b.add_text_sgmt("First segment", "#ffffff", "center")
            >>> b.add_text_sgmt("Second segment", "#aaaaaa", "left")
        """
        ...
    ...
    def add_text_line(self, text: str, color: str) -> None:
        ...
        Example:
            >>> b.add_text_sgmt("Line one", "#ffffff", "left")
            >>> b.add_text_line("Line two", "#aaaaaa")
        """
        ...
    ...
    def add_col_text_sgmt(self, align: str, column_count: int) -> None:
        ...
        Columnar segments place content side-by-side in equal-width columns
        by default. Use ``set_segment_ratios`` to control relative widths.
    ...
    def add_col_text_line(self, text: str, color: str, col_index: int) -> None:
        """Add a line of text to a column in the most recently added columnar segment.

        Args:
            text: The text content for this cell.
            color: Hex color string for this cell's text.
            col_index: Zero-based column index to add this line to.
        """
        ...
    ...
    def add_col_text_line_indx(
        ...
        """Add a line of text to a column in a specific columnar segment.
    ...
    def set_padding(self, internal: int, external: int) -> None:
        ...
        Example:
            >>> b.set_padding(1, 2)  # 1 col inside border, 2 cols outside
        """
        ...
    ...
    def render(self, width: int) -> list[str]:
        ...
        Each string in the returned list is one fully-composed terminal line,
        including ANSI color escape codes and box-drawing characters.

        Args:
            width: Total column width to render into.

        Returns:
            One line per entry. Pass to ``print``, write to a file, assert
            in tests, or pipe into another renderer.
